...
from app.query import run_query
from app.charts.utils import build_base_chart
...
class TimeseriesAnalysis(object):
    def __init__(self, data_id,tenant_id, report_type, cfg):
    ...
    def run(self):
        data = run_query(
            self.data_instance.get_data(),
            self.data_instance.get_query(),
            self.data_instance.context_variables,
        )
