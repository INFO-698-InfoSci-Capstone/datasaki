...
import numpy as np
import pandas as pd
from app.utils import classify_type, find_dtype, format_data, make_list
from app.query import build_col_key
...
class ColumnFilter(object):
    def __init__(self, data_id,tenant_id, column, cfg):
        self.tenant_id = tenant_id
        self.data_id = data_id
        self.data_instance = ArcticDBInstance(tenant_id=tenant_id,dataset_id=self.data_id)
        self.column = column
        dtype = self.data_instance.dtypes
    ...
    def save_filter(self):
        ...
        self.data_instance.settings=curr_settings
        return curr_filters
