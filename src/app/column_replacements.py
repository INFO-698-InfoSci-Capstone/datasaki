...
from app.column_builders import ReplaceColumnBuilder
from app.utils import classify_type, find_dtype, dict_merge


class ColumnReplacement(object):
    def __init__(self, data_id,tenant_id, col, replacement_type, cfg, name=None):
    ...
    def build_replacements(self):
        return self.builder.build_column(self.data_instance.get_data())

    def build_code(self):
        return self.builder.build_code(self.data_instance.get_data())
